...
class LearningTableCell: UITableViewCell {
    ...
    private lazy var bannerCollectionView: UICollectionView = {
        ...
        collectionView.register(LearningLessonCell.self, forCellWithReuseIdentifier: "LearningLessonCell")
...
extension LearningTableCell {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            bannerCollectionView.heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.width / 3.2))
        ])
    }
...
extension LearningTableCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "LearningLessonCell", for: indexPath) as! LearningLessonCell
        cell.configure(with: banners[indexPath.item])
        return cell
    }
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        CGSize(width: (bannerCollectionView.frame.width), height: (UIScreen.main.bounds.width / 3.7))
    }
